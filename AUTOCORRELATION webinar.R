...
# Load 2003 DHS data
#data1 <- read_dta("C:/Users/Ezra Gayawan/Documents/DHS Data/DHS Children recode 2013_2018/Children 2003 with soattial covariates/NGKR4BDT/NGKR4BFL.DTA")
...
data2 <- read_dta("C:/Users/Ezra Gayawan/Documents/DHS Data/DHS Children recode 2013_2018/Children 2008 with spatial covariates/NGKR53DT/NGKR53FL.DTA")
...
#data1_new <- select(data1, "state", "v461")
...
#data1_new <- select(data1, REGCODE = state, v461)
...
# Read the shapefile
map1 <- st_read("C:/Users/Ezra Gayawan/Documents/DHS Data/GPS data/Nig2008/shps/sdr_subnational_boundaries2.shp")

# Join the prevalence data to the shapefile using REGCODE
new_data <- left_join(map1, merged_data, by = "REGCODE")
