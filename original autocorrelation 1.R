...
map <- st_read("~/sdr_subnational_boundaries2.shp")
View(map)
...
state_mapping <- data.frame(sstate = c(21, 36, 12, 25, 30, 6, 8, 34, 3, 11, 10, 26, 15, 37, 35, 19, 
...
data1_new <- select(data1, "sstate", "v461")
...
data1_new <- select(data1, REGCODE = sstate, v461)
View(data1_new)
...
bed_nets_usage <- left_join(map1, data1_new, by = "REGCODE")
View(map1)
View(data1_new)
# View the spatial data using interactive map, colored by prevalence
mapview(bed_nets_usage, zcol = "prevalence")
